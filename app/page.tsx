...
export default function Home() {
  return (
    <main className="flex min-h-screen w-full flex-col justify-center gap-10 px-6 py-14 sm:px-10">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <a
          href="/calendario"
          className="inline-flex items-center rounded-xl border border-zinc-300 px-5 py-3 font-semibold text-zinc-700 transition hover:bg-zinc-100"
        >
